...
response1 = basic_agent.run("你好，你能做什么？")
...
enhanced_agent = MySimpleAgent(
    name="增强助手",
    llm=llm,
    system_prompt="你是一个强大的AI助手，可以调用工具来解决复杂问题。",
    tool_registry=tool_registry,
    enable_tool_calling = True
)


response2 = enhanced_agent.run("帮我计算一下 114514 ✖️ 1919 次方等于多少？")
print(f"工具增强对话响应: {response2}\n")
...
print("=== 测试3:流式响应 ===")
print("流式响应: ", end="")
for chunk in basic_agent.stream_run("请解释人类是什么:"):
    pass
